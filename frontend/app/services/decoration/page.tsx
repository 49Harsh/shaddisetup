...
export default function DecorationPage() {
  ...
  const packages = tr.decoPackages[lang];
    ...
    <div>
      <section style={{ background: "#fff", padding: "72px 20px", textAlign: "center", borderBottom: "2px solid #eee" }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 18, color: "#555", lineHeight: 1.8, marginBottom: 32 }}>{t(tr.decoDesc)}</p>
          <a href={`https://wa.me/919999999999?text=${lang === "en" ? "I need decoration information" : "मुझे डेकोरेशन के बारे में जानकारी चाहिए"}`}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 28 }}>
            {packages.map((p, i) => (
              <div key={i} style={{ border: i === 1 ? "2px solid #b5451b" : "1.5px solid #eee", borderRadius: 16, padding: "32px 24px", background: "#fff", position: "relative" }}>
                ...
                <a href={`https://wa.me/919999999999?text=${lang === "en" ? "I want to book decoration" : "मुझे डेकोरेशन बुक करना है"}`}
                  target="_blank" rel="noopener noreferrer"
